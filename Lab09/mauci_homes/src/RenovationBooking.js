import { Navbar, Nav, NavItem, NavDropdown, MenuItem, Form, FormControl, FormGroup, Button, InputGroup, Select, Alert, Tooltip, OverlayTrigger } from 'react-bootstrap';
import { Jumbotron, Container, Row,Col } from 'react-bootstrap';
import 'bootstrap/dist/css/bootstrap.min.css'
import React, { useState } from 'react';
import DatePicker from "react-datepicker";
import icon1 from './images/Icons/info2.png'
import icon2 from './images/Icons/payment 1.png'
import icon3 from './images/Icons/personal info 1.png'
import icon4 from './images/Icons/info 1.png'
import "react-datepicker/dist/react-datepicker.css";


const RenovationBooking = () => {
    ...
    const renderTooltip = (props) => (
        <Tooltip id="button-tooltip" {...props}>
          We charge a downpayment of $50 per consultation
        </Tooltip>
      );
    ...
    const valadateCheck = () => {
        valadate();
        if ((show1 == true) || (show2 == true) ||(show3 == true) || (show4 == true) ||(show5 == true) ||(show6 == true) ||(show7 == true) ||(show8 == true) ||(show9 == true) ||(show10 == true) ||(show11 == true) ||(show12 == true) ||(show13 == true) ||(show14 == true)){
            setShow15(false);
        }
        else{
            setShow15(true);
    ...
    return (  
        <div className="RenovationBooking">
            ...
            <h1 className="renovationConsultationHeader">Renovation Consultation Appointment</h1>
            ...
            <h1 className="formHeader"><br/><img src={icon2} className="iconHead" alt="Header Image" ></img>Payment Information<OverlayTrigger
    placement="right"
  ...
  >
            ...
            <Form>
                <Row className="align-items-center">
                    ...
                    <InputGroup>
                        <InputGroup.Text>First Name</InputGroup.Text>
                        <FormControl id="inlineFormInputGroupfirstname" placeholder="John" value={firstName2} onChange={(e) => setFirstName2(e.target.value)} />
                    </InputGroup>
                    <Alert show={show9} variant="danger" className="Alert">
                                <p>
                                Please Enter Your First Name!
                                </p>
                            </Alert>
                    ...
                    <InputGroup>
                        <InputGroup.Text>Last Name</InputGroup.Text>
                        <FormControl id="inlineFormInputGrouplastName" placeholder="Doe" value={lastName2} onChange={(e) => setLastName2(e.target.value)}/>
                    </InputGroup>
                    <Alert show={show10} variant="danger" className="Alert">
                                <p>
                                Please Enter Your Last Name!
                                </p>
                            </Alert>
                ...
                <Col sm={5} className="my-1">
                    ...
                    <InputGroup>
                        ...
                        <FormControl id="inlineFormInputGrouplastName" placeholder="1234-1234-1234-1234"  value={cardNumber} onChange={(e) => setCardNumber(e.target.value)} />
                    </InputGroup>
                    <Alert show={show11} variant="danger" className="Alert">
                                <p>
                ...
                <Row className="align-items-center">
                    ...
                    <Alert show={show12} variant="danger" className="Alert">
                                <p>
                ...
                <Row className="align-items-center">
                    <Col sm={5} className="my-1">
                        ...
                        <InputGroup>
                                ...
                                <FormControl id="inlineFormInputGrouplastName" placeholder="123" value={cvv} onChange={(e) => setCvv(e.target.value)} />
                    </InputGroup>
                    <Alert show={show13} variant="danger" className="Alert">
                                <p>
